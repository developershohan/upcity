...
import { getProductByFilter } from "../features/product/ProductApiSlice";

export default function Pagination({ totalItems = 55 }) {
  ...
  useEffect(() => {
    ...
    dispatch(getProductByFilter(pagination));
  }, [dispatch, page]);
